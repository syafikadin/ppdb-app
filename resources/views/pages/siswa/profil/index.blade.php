                    ...
                    <div class="card shadow mt-3">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="rata_penghasilan" class="form-select" aria-label="Rata Rata Penghasilan"
                                    required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nomor_wa') is-invalid @enderror"
                                    id="nomor_wa" name="nomor_wa" required value="{{ old('nomor_wa') }}">
                                @error('nomor_wa')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('foto') is-invalid @enderror" type="file"
                                    id="foto" name="foto" onchange="previewImage(this, '.img-preview')">
                                @error('foto')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
